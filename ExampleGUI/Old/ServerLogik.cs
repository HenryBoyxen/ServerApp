...
//        {
//            _serverPage.Dispatcher.Invoke(() => _serverPage.txt_server.Text = message + "\n" + _serverPage.txt_server.Text);
//            Thread.Sleep(100);
//        }
...
//            _listener.Start();
//            WriteOnConsole("Der Server wurde erfolgreich gestartet und wartet auf eingehende Anfragen.");
//            while (!token.IsCancellationRequested)
//            {
//                if (_listener.Pending())
//                {
//                    WriteOnConsole("Es wurde ausstehende Verbindung gefunden...");
//                    Task.Run(() => AcceptTcpClient());
//                }
//            }
//            WriteOnConsole("Der Server wird heruntergefahren...");
//            _listener.Stop();
//            WriteOnConsole("Der Server wurde erfolgreich gestoppt!");
//        }
...
//                    WriteOnConsole("Es wurde folgende Anfrage gestellt: " + request);

//                    HandleRequest(request, stream, sw);

//                    WriteOnConsole("Die Anfrage wurde erfolgreich bearbeitet!");
...
//            catch
//            {
//                WriteOnConsole("Bei der Anfrage ist etwas schief gelaufen...");
//            }
//        }
...
//        private static async void Request_anmelden_anmelden(NetworkStream pStream, StreamWriter pStreamWriter)
//        {
